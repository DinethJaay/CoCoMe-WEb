...
if(isset($_POST['submit'])){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $insert_user = $conn->prepare("INSERT INTO `users`(name, email, number,type, password) VALUES(?,?,?,?,?)");
         $insert_user->execute([$name, $email, $number,$type, $cpass]);
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <select name="type" class="box"onkeyup="validate_User_Role()">
