      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               ...
               <a href="menu.php" class="btn">See Coconut Products</a>
            </div>
            <div class="image">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               <span>order online</span>
               <h3>Tea Products</h3>
               <a href="menu.php" class="btn">See Tea Products</a>
            </div>
            <div class="image">
         ...
         <div class="swiper-slide slide">
            <div class="content">
               ...
               <a href="menu.php" class="btn">See Rubber Products</a>
            </div>
            <div class="image">
...
<section class="category">
   ...
   <div class="box-container">
      ...
      <a href="category.php?category=Coconut" class="box">
      ...
      <a href="category.php?category=Rubber" class="box">
         <img src="images/rub1.jpg" alt="">
         <h3>Rubber Products</h3>
      </a>
